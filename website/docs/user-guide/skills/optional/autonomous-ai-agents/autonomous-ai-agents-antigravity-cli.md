---
title: "Antigravity Cli — Operate the Antigravity CLI (agy 2.x): headless runs, auth, plugins, sandbox"
...
Operate the Antigravity CLI (agy 2.x): headless runs, auth, plugins, sandbox.
